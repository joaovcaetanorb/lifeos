...
(_FRONTEND_DIR / "revisao").mkdir(parents=True, exist_ok=True)
...
def _startup() -> None:
    ...
    modulos = (
        ...
        ("revisão", inicializar_banco_revisao),
    )
...
app.mount("/revisao", StaticFiles(directory=str(_FRONTEND_DIR / "revisao"), html=True), name="revisao-frontend")
